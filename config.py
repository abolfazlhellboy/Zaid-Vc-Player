...
BOT_TOKEN = getenv("BOT_TOKEN", "5453156362:AAEHSOFv-BqKMuqSY05lm7DbLQlXppzFGDg")
BOT_NAME = getenv("BOT_NAME", "Hellboy music")

API_ID = int(getenv("API_ID", "13439299"))
API_HASH = getenv("API_HASH", "17fd60de2457279eea687509ba024b7e")
...
OWNER_NAME = getenv("OWNER_NAME", "HELL")
OWNER_USERNAME = getenv("OWNER_USERNAME", "hellboyhell1090")
ALIVE_NAME = getenv("ALIVE_NAME", "Zaid")
BOT_USERNAME = getenv("BOT_USERNAME", "hell1999musicbot")
OWNER_ID = getenv("OWNER_ID", "5405287017")
...
SUDO_USERS = list(map(int, getenv("SUDO_USERS", "5405287017").split()))
